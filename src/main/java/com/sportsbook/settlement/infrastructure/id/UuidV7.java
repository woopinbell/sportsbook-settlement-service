 ...
 * which is the main reason we use v7 instead of v4 for primary keys (ADR-0003). Used here for the
 * surrogate keys of the read-model selections and the outbox rows.
 */
